...
public class StreamAppMain {
    public static void main(String[] args) {
        ...
        lst.stream()
            ...
            long cnt =li.stream().filter(str->str.contains("a"))
                        .map(str->str.toUpperCase())
                        .peek(System.out::println)
                        .count();
            System.err.println(cnt);
            System.out.println("객체를 담아서 처리하는 방법");
            Stream<File> fileStream=Stream.of(new File("siat.txt"), new File("java.txt"), new File("jslim.txt"),new File("siat.txt"));
